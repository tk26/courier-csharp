...
namespace Com.Courier.Model
{
    ...
    public partial class InlineResponse2002 : IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="results">An array of events of a previously sent message.</param>
        public InlineResponse2002(List<Object> results = default(List<Object>))
        {
        ...
        /// </summary>
        /// <value>An array of events of a previously sent message</value>
