...
namespace Com.Courier.Model
{
    ...
    public partial class InlineResponse200 : IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="messageId">A unique identifier associated with the message sent..</param>
        public InlineResponse200(string messageId = default(string))
        {
        ...
        /// </summary>
        /// <value>A unique identifier associated with the message sent.</value>
